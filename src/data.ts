...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    solution: 'Caffeine Toggle adds two native Control Center controls: a one-click ON/OFF mug plus Timer and Calendar-style Repeat for 30-minute–8-hour sessions or daily, weekly, monthly, yearly, and custom recurrences.',
